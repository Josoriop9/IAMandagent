...
- ✅ **161 tests total** — guard (14) + CLI (26) + API (15) + models/crypto/identity (42) + ledger (26) + templates (37) + cli-network (15), all green
- ✅ **Code coverage 55%** — up from 37%; `coverage.xml` generated by CI, badge in README
